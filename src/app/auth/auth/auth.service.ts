...
export class AuthService {
    ...
    signup(email: string, password: string) {
        return this.httpClient.post<AuthResponceData>(
            'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDEGektOtEBWjPczgqT0ZN8tZHp_wuWRn0',
            {
                email: email,
                password: password,
    ...
    loging(email: string, password: string) {
        return this.httpClient.post<AuthResponceData>(
            'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDEGektOtEBWjPczgqT0ZN8tZHp_wuWRn0',
            {
                email: email,
                password: password,
                returnSecureToken: true
